...
export class RenderController {
  ...
  async loadDir(dirPath, outputPath, category, cb) {
    ...
    fileNames.map(async (fileName) => await this.addArticle(fileName, category));
    ...
    shouldCopyArticleAssertNames.map(async (shouldCopyArticleAssertName) => {
    ...
    await this.syncMappingDirs(needMapping, mappingRules, dirPath, outputPath)
    
    subCateDirs.map(async (subDir) => {
  ...
  async syncMappingDirs(needMapping, mappingRules, dirPath, outputPath) {
  ...
  async addArticle(fileName, category, cb){
