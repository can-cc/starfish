...
export class RenderController {
        ...
        category.articles.sort((a, b) => {
            ...
            parseToData(path.join(inputPath, articleInfo.fileName), (err, articleDoc) => {
                if( !err ){
                    ...
                    fs.readFile(path.resolve(self.themePath, 'templates/article.html'),
                                'utf-8', (err, data) => {
                                    ...
                                    let contentPart = RenderController.cutOffArticle(articleDoc.content, relativeOutputPath);
    ...
    renderIndex(cb) {
        ...
        _.chunk(allarticles, this.options.BLOG.INDEX_ARTICLE_NUMBER).map((articles, i) => {
            let done = mapdone.reg();
            fs.readFile(path.resolve(self.themePath, 'templates/index.html'),
                        'utf-8', (err, data) => {
