...
export class RenderController {
    constructor(inputPath, outputRoot, options) {
        ...
        this.themePath = options.STYLE.THEMEDIR;
    }
    ...
    render(cb) {
        ...
        this.loadDir(this.inputPath, this.outputRoot, 'index', () => {
            fsExtra.copy(path.join(this.inputPath, this.themePath, this.theme, 'static'),
                ...
                if( !err ){
                    ...
                    fs.readFile(path.resolve(__dirname, '..', themePath, self.theme, 'article.html'),
                                'utf-8', (err, data) => {
                                    ...
                                    articleInfo = R.merge(articleInfo, {
                                        title: article.title,
                                        ...
                                        showTime: articleInfo.dateInfo.create.format('long', 'zh-CN')
                                    });
