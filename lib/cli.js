...
import {isFile, isDir, logCurrentTime, injectGlobal} from './util';
...
cli.run = function() {
    ...
    case 'serve':
        ...
        readConfigure(inputPath);
        
        let tickProcess = new TickProcess();
        tickProcess.start();
        let renderControl = new RenderController(inputPath, outputTmpPath, readConfigure(inputPath));
